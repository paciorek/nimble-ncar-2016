...
subtitle: "UC Berkeley D-Lab Workshop"
...
The Github site ([https://github.com/paciorek/nimble-dlab-2016](https://github.com/paciorek/nimble-dlab-2016)) is the master repository for materials for the modules; you can also get the individual files from Github. 

To get the materials look ahead to slide 6 for instructions. Alternatively, simply go to [https://github.com/paciorek/nimble-dlab-2016](https://github.com/paciorek/nimble-dlab-2016) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/paciorek/nimble-dlab-2016/archive/master.zip).
...
You can simply download a zip file with all the material to your hard drive from [our Github repository](https://github.com/paciorek/nimble-dlab-2016). Look for the ```Download ZIP``` button in the lower right.

## Within RStudio

Within RStudio go to File->New Project->Version Control->Git and enter:

- "Repository URL": https://github.com/paciorek/nimble-dlab-2016
...
- `git clone https://github.com/paciorek/nimble-dlab-2016`
...
2. install the *igraph* package (this is available on CRAN so you can
...
Exercises can be found [here](exercises_dlab_2016.html).
